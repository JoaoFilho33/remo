...
import com.backend.remo.core.config.JwtService;
import com.backend.remo.core.token.Token;
import com.backend.remo.core.token.TokenRepository;
import com.backend.remo.core.token.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        if (request.getRole() == null) role = Role.USER;
